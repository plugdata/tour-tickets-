  ...
  try {
    ...
    const busRound = await prisma.busRound.create({
      data: {
        ...
        departureDate: draft.departDate || new Date(),
        departureTimes: JSON.stringify(['06:00', '08:00']),
        duration: draft.duration,
        totalSeats: draft.totalSeats || 50,
        seatsPerTime: Math.floor((draft.totalSeats || 50) / 2),
        roundNo: draft.roundNo || 1,
        responsiblePerson: draft.responsiblePerson,
        extraPrice: draft.extraPrice || 0,
