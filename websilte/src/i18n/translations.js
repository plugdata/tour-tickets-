/**
 * GUGA Travels — i18n Translations
 * Pattern: i18next-compatible flat key → value
 * Supports: th (Thai default) | en (English)
 */
export const resources = {
  th: {
    translation: {
      ...
      nav_lang: 'EN',
      nav_status: 'ตรวจสอบสถานะการจอง',

      // ── Hero ──
      hero_title: 'โตละ...จะไปไหนก็ได้',
      hero_subtitle: 'Grow up, Go anywhere — เปิดโลกกว้าง สัมผัสธรรมชาติ เติมประสบการณ์ใหม่ กับทีมงานมืออาชีพที่ดูแลคุณตลอดการเดินทาง',
      hero_btn: 'เช็คทริปและจองทริป',
      hero_badge: 'บทความ & ประกาศ',

      // ── Fire Section ──
      fire_hot: 'ทริปฮอต',
      fire_subtitle: 'อัปเดตทริปล่าสุด — จองก่อนได้ก่อน!',
      ...
      // ── International ──
      intl_title: 'ทริปต่างประเทศ',
      intl_subtitle: 'ก้าวข้ามพรมแดน สู่จุดหมายที่ดีที่สุด',
      view_all: 'ดูทริปทั้งหมด →',

      // ── Features ──
      feat1_title: 'ทีมงานมากประสบการณ์',
      feat1_text: 'ทีมงานมากประสบการณ์ดูแลทุกรายละเอียด เพื่อความปลอดภัย ความสะดวกสบาย และประสบการณ์ของผู้เดินทาง',
      feat2_title: 'เรื่องอาหารไว้ใจเราได้',
      feat2_text: 'เติมพลังหลังการเดินป่าด้วยเมนูอาหารสุดอร่อย พร้อมเครื่องดื่ม',
      feat3_title: 'มิตรภาพระหว่างทาง',
      feat3_text: 'พบเพื่อนใหม่ สร้างความทรงจำร่วมกัน เป็นมากกว่าทริป',
      feat4_title: 'การท่องเที่ยวเชิงอนุรักษ์',
      feat4_text: 'การท่องเที่ยวที่ใส่ใจธรรมชาติและชุมชนท้องถิ่น ลดผลกระทบต่อสิ่งแวดล้อม',
      ...
      faq4_a: 'จุดนัดพบส่วนใหญ่จะอยู่ที่กรุงเทพฯ หรือจังหวัดที่เป็นจุดเริ่มต้นของทริป ทางทีมจะแจ้งรายละเอียดให้ทราบล่วงหน้า',
      faq5_q: 'มีบริการเช่าอุปกรณ์ (เต้นท์, ถุงนอน) หรือไม่?',
      faq5_a: 'มีบริการให้เช่าอุปกรณ์ครบครัน ทั้งเต้นท์, ถุงนอน และอุปกรณ์เดินป่าอื่นๆ ในราคาที่เหมาะสม',
  ...
  en: {
    translation: {
      ...
      nav_lang: 'TH',
      nav_status: 'Check booking status',

      // ── Hero ──
      hero_title: 'Grow Up, Go Anywhere',
      hero_subtitle: 'Grow up, Go anywhere — explore the world, embrace nature, create new experiences with a professional team that cares for you throughout your journey.',
      hero_btn: 'Browse & Book Trips',
      hero_badge: 'Articles & Announcements',

      // ── Fire Section ──
      fire_hot: 'Hot Trips',
      fire_subtitle: 'Latest updates — Book early, go first!',
      ...
      // ── International ──
      intl_title: 'International Trips',
      intl_subtitle: 'Cross borders to the very best destinations',
      view_all: 'View All Trips →',

      // ── Features ──
      feat1_title: 'Experienced Team',
      feat1_text: 'Our experienced team handles every detail to ensure your safety, comfort, and a truly memorable travel experience.',
      feat2_title: 'Delicious Food, Guaranteed',
      feat2_text: 'Recharge after the trek with delicious meals and refreshing drinks.',
      feat3_title: 'Friendships Along the Way',
      feat3_text: 'Meet new friends, build shared memories — it\'s more than just a trip.',
      feat4_title: 'Eco-Conscious Travel',
      feat4_text: 'Travel that respects nature and local communities, reducing environmental impact.',
      ...
      faq_subtitle: 'Questions about your trip — we have the answers',
      ...
      faq4_a: 'Meeting points are usually in Bangkok or at the trip\'s starting province. Our team will notify you in advance.',
      faq5_q: 'Is there gear rental available (tent, sleeping bag)?',
      faq5_a: 'Yes! We offer full gear rental — tents, sleeping bags, and other hiking equipment at reasonable prices.',
